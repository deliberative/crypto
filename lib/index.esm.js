...
const memoryLenToPages = (memoryLen, minPages, maxPages) => {
    ...
    if (ceil > maxPages)
        throw new Error(`Memory requirements larger than declared maximum ${maxPages * pageSize} bytes`);
...
var e;e||(e=typeof libsodiumMethodsModule !== 'undefined' ? libsodiumMethodsModule : {});var aa,ba;e.ready=new Promise(function(a,b){aa=a;ba=b;});var ca=Object.assign({},e),da=[],ea="./this.program",k=(a,b)=>{throw b;},fa="object"==typeof window,l="function"==typeof importScripts,t="object"==typeof process&&"object"==typeof process.versions&&"string"==typeof process.versions.node,u="",ha,v,w,fs,x,ia;
if(t)u=l?require("path").dirname(u)+"/":__dirname+"/",ia=()=>{x||(fs=require("fs"),x=require("path"));},ha=function(a,b){ia();a=x.normalize(a);return fs.readFileSync(a,b?void 0:"utf8")},w=a=>{a=ha(a,!0);a.buffer||(a=new Uint8Array(a));return a},v=(a,b,c)=>{ia();a=x.normalize(a);fs.readFile(a,function(d,f){d?c(d):b(f.buffer);});},1<process.argv.length&&(ea=process.argv[1].replace(/\\/g,"/")),da=process.argv.slice(2),k=(a,b)=>{if(noExitRuntime)throw process.exitCode=a,b;b instanceof ja||y("exiting due to exception: "+
b);process.exit(a);},e.inspect=function(){return "[Emscripten Module object]"};else if(fa||l)l?u=self.location.href:"undefined"!=typeof document&&document.currentScript&&(u=document.currentScript.src),_scriptDir&&(u=_scriptDir),0!==u.indexOf("blob:")?u=u.substr(0,u.replace(/[?#].*/,"").lastIndexOf("/")+1):u="",ha=a=>{var b=new XMLHttpRequest;b.open("GET",a,!1);b.send(null);return b.responseText},l&&(w=a=>{var b=new XMLHttpRequest;b.open("GET",a,!1);b.responseType="arraybuffer";b.send(null);return new Uint8Array(b.response)}),
v=(a,b,c)=>{var d=new XMLHttpRequest;d.open("GET",a,!0);d.responseType="arraybuffer";d.onload=()=>{200==d.status||0==d.status&&d.response?b(d.response):c();};d.onerror=c;d.send(null);};var ka=e.print||console.log.bind(console),y=e.printErr||console.warn.bind(console);Object.assign(e,ca);ca=null;e.arguments&&(da=e.arguments);e.thisProgram&&(ea=e.thisProgram);e.quit&&(k=e.quit);var z=e.dynamicLibraries||[],A;e.wasmBinary&&(A=e.wasmBinary);var noExitRuntime=e.noExitRuntime||!0;
...
function oa(a){for(var b=0,c=0;c<a.length;++c){var d=a.charCodeAt(c);127>=d?b++:2047>=d?b+=2:55296<=d&&57343>=d?(b+=4,++c):b+=3;}return b}var F,pa,G,H,qa,ra=e.INITIAL_MEMORY||16777216;e.wasmMemory?C=e.wasmMemory:C=new WebAssembly.Memory({initial:ra/65536,maximum:ra/65536});C&&(F=C.buffer);ra=F.byteLength;var I=F;F=I;e.HEAP8=pa=new Int8Array(I);e.HEAP16=new Int16Array(I);e.HEAP32=H=new Int32Array(I);e.HEAPU8=G=new Uint8Array(I);e.HEAPU16=new Uint16Array(I);e.HEAPU32=new Uint32Array(I);e.HEAPF32=new Float32Array(I);
e.HEAPF64=qa=new Float64Array(I);var J=new WebAssembly.Table({initial:16,element:"anyfunc"}),sa=[],ta=[],ua=[],va=[],wa=[],K=!1;function xa(){var a=e.preRun.shift();sa.unshift(a);}var L=0,M=null;function Aa(){L++;e.monitorRunDependencies&&e.monitorRunDependencies(L);}function Ba(){L--;e.monitorRunDependencies&&e.monitorRunDependencies(L);if(0==L&&(M)){var a=M;M=null;a();}}
function B(a){if(e.onAbort)e.onAbort(a);a="Aborted("+a+")";y(a);la=!0;a=new WebAssembly.RuntimeError(a+". Build with -sASSERTIONS for more info.");ba(a);throw a;}function Ca(){return N.startsWith("data:application/octet-stream;base64,")}var N;N="libsodiumMethodsModule.wasm";if(!Ca()){var Da=N;N=e.locateFile?e.locateFile(Da,u):u+Da;}function Ea(){var a=N;try{if(a==N&&A)return new Uint8Array(A);if(w)return w(a);throw "both async and sync fetching of the wasm failed";}catch(b){B(b);}}
...
var Ga={33664:()=>e.K(),33700:()=>{if(void 0===e.K)try{var a="object"===typeof window?window:self,b="undefined"!==typeof a.crypto?a.crypto:a.msCrypto;a=function(){var d=new Uint32Array(1);b.getRandomValues(d);return d[0]>>>0};a();e.K=a;}catch(d){try{var c=require("crypto");a=function(){var f=c.randomBytes(4);return (f[0]<<24|f[1]<<16|f[2]<<8|f[3])>>>0};a();e.K=a;}catch(f){throw "No secure random number generator found";}}}};
function ja(a){this.name="ExitStatus";this.message="Program terminated with exit("+a+")";this.status=a;}var O={},Ha=new Set([]),Ia={get:function(a,b){(a=O[b])||(a=O[b]=new WebAssembly.Global({value:"i32",mutable:!0}));Ha.has(b)||(a.required=!0);return a}};function P(a){for(;0<a.length;)a.shift()(e);}
function Ja(a){function b(){for(var n=0,r=1;;){var E=a[f++];n+=(E&127)*r;r*=128;if(!(E&128))break}return n}function c(){var n=b();f+=n;return D(a,f-n,n)}function d(n,r){if(n)throw Error(r);}var f=0,g=0,h="dylink.0";a instanceof WebAssembly.Module?(g=WebAssembly.Module.customSections(a,h),0===g.length&&(h="dylink",g=WebAssembly.Module.customSections(a,h)),d(0===g.length,"need dylink section"),a=new Uint8Array(g[0]),g=a.length):(g=1836278016==(new Uint32Array((new Uint8Array(a.subarray(0,24))).buffer))[0],
d(!g,"need to see wasm magic number"),d(0!==a[8],"need the dylink section to be first"),f=9,g=b(),g=f+g,h=c());var m={B:[],ia:new Set,aa:new Set};if("dylink"==h){m.L=b();m.X=b();m.J=b();m.ha=b();h=b();for(var p=0;p<h;++p){var q=c();m.B.push(q);}}else for(d("dylink.0"!==h);f<g;)if(h=a[f++],p=b(),1===h)m.L=b(),m.X=b(),m.J=b(),m.ha=b();else if(2===h)for(h=b(),p=0;p<h;++p)q=c(),m.B.push(q);else if(3===h)for(h=b();h--;)p=c(),q=b(),q&256&&m.ia.add(p);else if(4===h)for(h=b();h--;)c(),p=c(),q=b(),1==(q&3)&&
m.aa.add(p);else f+=p;return m}function Ka(a){var b=["stackAlloc","stackSave","stackRestore"];return 0==a.indexOf("dynCall_")||b.includes(a)?a:"_"+a}function La(a){for(var b in a)if(a.hasOwnProperty(b)){Q.hasOwnProperty(b)||(Q[b]=a[b]);var c=Ka(b);e.hasOwnProperty(c)||(e[c]=a[b]);"__main_argc_argv"==b&&(e._main=a[b]);}}var Ma={},R=[];function Na(a){var b=R[a];b||(a>=R.length&&(R.length=a+1),R[a]=b=J.get(a));return b}
function Oa(a){return function(){var b=Pa();try{var c=arguments[0],d=Array.prototype.slice.call(arguments,1);if(a.includes("j")){var f=e["dynCall_"+a];var g=d&&d.length?f.apply(null,[c].concat(d)):f.call(null,c);}else g=Na(c).apply(null,d);return g}catch(h){Qa(b);if(h!==h+0)throw h;Ra(1,0);}}}var Sa=10521760;function Ta(a){if(K)return Ua(a);var b=Sa;Sa=a=b+a+15&-16;O.__heap_base.value=a;return b}function Va(a,b){if(S)for(var c=a;c<a+b;c++){var d=Na(c);d&&S.set(d,c);}}var S=void 0,Wa=[];
function Xa(a,b){S||(S=new WeakMap,Va(0,J.length));if(S.has(a))return S.get(a);if(Wa.length)var c=Wa.pop();else {try{J.grow(1);}catch(m){if(!(m instanceof RangeError))throw m;throw "Unable to grow wasm table. Set ALLOW_TABLE_GROWTH.";}c=J.length-1;}try{var d=c;J.set(d,a);R[d]=J.get(d);}catch(m){if(!(m instanceof TypeError))throw m;if("function"==typeof WebAssembly.Function){d=WebAssembly.Function;for(var f={i:"i32",j:"i64",f:"f32",d:"f64",p:"i32"},g={parameters:[],results:"v"==b[0]?[]:[f[b[0]]]},h=1;h<
b.length;++h)g.parameters.push(f[b[h]]);d=new d(g,a);}else {d=[1,96];f=b.slice(0,1);b=b.slice(1);g={i:127,p:127,j:126,f:125,d:124};h=b.length;128>h?d.push(h):d.push(h%128|128,h>>7);for(h=0;h<b.length;++h)d.push(g[b[h]]);"v"==f?d.push(0):d.push(1,g[f]);b=[0,97,115,109,1,0,0,0,1];f=d.length;128>f?b.push(f):b.push(f%128|128,f>>7);b.push.apply(b,d);b.push(2,7,1,1,101,1,102,0,0,7,5,1,1,102,0,0);d=new WebAssembly.Module(new Uint8Array(b));d=(new WebAssembly.Instance(d,{e:{f:a}})).exports.f;}b=c;J.set(b,d);
R[b]=J.get(b);}S.set(a,c);return c}
function Ya(a,b){var c={},d;for(d in a){var f=a[d];"object"==typeof f&&(f=f.value);"number"==typeof f&&(f+=b);c[d]=f;}a=void 0;for(var g in c)!"__cpp_exception __c_longjmp __wasm_apply_data_relocs __dso_handle __tls_size __tls_align __set_stack_limits _emscripten_tls_init __wasm_init_tls __wasm_call_ctors".split(" ").includes(g)&&(b=c[g],g.startsWith("orig$")&&(g=g.split("$")[1],a=!0),O[g]||(O[g]=new WebAssembly.Global({value:"i32",mutable:!0})),a||0==O[g].value)&&("function"==typeof b?O[g].value=
Xa(b):"number"==typeof b?O[g].value=b:"bigint"==typeof b?O[g].value=Number(b):y("unhandled export type for `"+g+"`: "+typeof b));return c}function Za(a,b){var c;b&&(c=Q["orig$"+a]);c||(c=Q[a])&&c.oa&&(c=void 0);c||(c=e[Ka(a)]);!c&&a.startsWith("invoke_")&&(c=Oa(a.split("_")[1]));return c}function $a(a,b){return Math.ceil(a/b)*b}
function ab(a,b){function c(){function f(n){Va(m,d.J);p=Ya(n.exports,h);b.ba||bb();(n=p.__wasm_call_ctors)&&(K?n():ta.push(n));(n=p.__wasm_apply_data_relocs)&&(K?n():wa.push(n));return p}var g=Math.pow(2,d.X);g=Math.max(g,16);var h=d.L?$a(Ta(d.L+g),g):0,m=d.J?J.length:0;g=m+d.J-J.length;0<g&&J.grow(g);var p;g=new Proxy({},{get:function(n,r){switch(r){case "__memory_base":return h;case "__table_base":return m}if(r in Q)return Q[r];if(!(r in n)){var E;n[r]=function(){if(!E){var ya=Za(r,!1);ya||(ya=
p[r]);E=ya;}return E.apply(null,arguments)};}return n[r]}});g={"GOT.mem":new Proxy({},Ia),"GOT.func":new Proxy({},Ia),env:g,qa:g};if(b.A)return a instanceof WebAssembly.Module?(g=new WebAssembly.Instance(a,g),Promise.resolve(f(g))):WebAssembly.instantiate(a,g).then(function(n){return f(n.instance)});var q=a instanceof WebAssembly.Module?a:new WebAssembly.Module(a);g=new WebAssembly.Instance(q,g);return f(g)}var d=Ja(a);Ha=d.aa;if(b.A)return d.B.reduce(function(f,g){return f.then(function(){return cb(g,
b)})},Promise.resolve()).then(function(){return c()});d.B.forEach(function(f){cb(f,b);});return c()}
...
b)}):ab(c(a),b)}function f(h){g.global&&La(h);g.module=h;}b=b||{global:!0,M:!0};var g=Ma[a];if(g)return b.global&&!g.global&&(g.global=!0,"loading"!==g.module&&La(g.module)),b.M&&Infinity!==g.P&&(g.P=Infinity),g.P++,b.A?Promise.resolve(!0):!0;g={P:b.M?Infinity:1,name:a,module:"loading",global:b.global};Ma[a]=g;if(b.A)return d().then(function(h){f(h);return !0});f(d());return !0}
...
function eb(a,b,c,d){B("Assertion failed: "+(a?D(G,a):"")+", at: "+[b?b?D(G,b):"":"unknown filename",c,d?d?D(G,d):"":"unknown function"]);}eb.F="vppip";var fb=new WebAssembly.Global({value:"i32",mutable:!1},1024),gb=new WebAssembly.Global({value:"i32",mutable:!0},10521760),hb=new WebAssembly.Global({value:"i32",mutable:!1},1);function ib(){B("");}ib.F="v";var jb=[];
function kb(a,b,c){a-=1024;jb.length=0;var d;for(c>>=2;d=G[b++];)c+=105!=d&c,jb.push(105==d?H[c]:qa[c++>>1]),++c;return Ga[a].apply(null,jb)}kb.F="ippp";function lb(a,b,c){G.copyWithin(a,b,b+c);}lb.F="vppp";function mb(){B("OOM");}mb.F="ip";
var nb=(a,b)=>{for(var c=0,d=a.length-1;0<=d;d--){var f=a[d];"."===f?a.splice(d,1):".."===f?(a.splice(d,1),c++):c&&(a.splice(d,1),c--);}if(b)for(;c;c--)a.unshift("..");return a},ob=a=>{var b="/"===a.charAt(0),c="/"===a.substr(-1);(a=nb(a.split("/").filter(d=>!!d),!b).join("/"))||b||(a=".");a&&c&&(a+="/");return (b?"/":"")+a},pb=a=>{var b=/^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/.exec(a).slice(1);a=b[0];b=b[1];if(!a&&!b)return ".";b&&(b=b.substr(0,b.length-1));return a+b},qb=a=>
...
var wb={open:function(a){var b=tb[a.node.rdev];if(!b)throw new T(43);a.tty=b;a.seekable=!1;},close:function(a){a.tty.C.flush(a.tty);},flush:function(a){a.tty.C.flush(a.tty);},read:function(a,b,c,d){if(!a.tty||!a.tty.C.W)throw new T(60);for(var f=0,g=0;g<d;g++){try{var h=a.tty.C.W(a.tty);}catch(m){throw new T(29);}if(void 0===h&&0===f)throw new T(6);if(null===h||void 0===h)break;f++;b[c+g]=h;}f&&(a.node.timestamp=Date.now());return f},write:function(a,b,c,d){if(!a.tty||!a.tty.C.N)throw new T(60);try{for(var f=
0;f<d;f++)a.tty.C.N(a.tty,b[c+f]);}catch(g){throw new T(29);}d&&(a.node.timestamp=Date.now());return f}},xb={W:function(a){if(!a.input.length){var b=null;if(t){var c=Buffer.alloc(256),d=0;try{d=fs.readSync(process.stdin.fd,c,0,256,-1);}catch(f){if(f.toString().includes("EOF"))d=0;else throw f;}0<d?b=c.slice(0,d).toString("utf-8"):b=null;}else "undefined"!=typeof window&&"function"==typeof window.prompt?(b=window.prompt("Input: "),null!==b&&(b+="\n")):"function"==typeof readline&&(b=readline(),null!==
...
if(f>=a.node.m)return 0;a=Math.min(a.node.m-f,d);if(8<a&&g.subarray)b.set(g.subarray(f,f+a),c);else for(d=0;d<a;d++)b[c+d]=g[f+d];return a},write:function(a,b,c,d,f,g){if(!d)return 0;a=a.node;a.timestamp=Date.now();if(b.subarray&&(!a.g||a.g.subarray)){if(g)return a.g=b.subarray(c,c+d),a.m=d;if(0===a.m&&0===f)return a.g=b.slice(c,c+d),a.m=d;if(f+d<=a.m)return a.g.set(b.subarray(c,c+d),f),d}U.T(a,f+d);if(a.g.subarray&&b.subarray)a.g.set(b.subarray(c,c+d),f);else for(g=0;g<d;g++)a.g[f+g]=b[c+g];a.m=
Math.max(a.m,f+d);return d},D:function(a,b,c){1===c?b+=a.position:2===c&&32768===(a.node.mode&61440)&&(b+=a.node.m);if(0>b)throw new T(28);return b},R:function(a,b,c){U.T(a.node,b+c);a.node.m=Math.max(a.node.m,b+c);},Y:function(a,b,c,d,f){if(32768!==(a.node.mode&61440))throw new T(43);a=a.node.g;if(f&2||a.buffer!==F){if(0<c||c+b<a.length)a.subarray?a=a.subarray(c,c+b):a=Array.prototype.slice.call(a,c,c+b);c=!0;B();b=void 0;if(!b)throw new T(48);pa.set(a,b);}else c=!1,b=a.byteOffset;return {na:b,ja:c}},
$:function(a,b,c,d,f){if(32768!==(a.node.mode&61440))throw new T(43);if(f&2)return 0;U.l.write(a,b,0,d,c,!1);return 0}}},Db=null,Eb={},Fb=[],Gb=1,V=null,Hb=!0,T=null,Bb={},W=(a,b={})=>{a=sb("/",a);if(!a)return {path:"",node:null};b=Object.assign({V:!0,O:0},b);if(8<b.O)throw new T(32);a=nb(a.split("/").filter(h=>!!h),!1);for(var c=Db,d="/",f=0;f<a.length;f++){var g=f===a.length-1;if(g&&b.parent)break;c=Cb(c,a[f]);d=ob(d+"/"+a[f]);c.I&&(!g||g&&b.V)&&(c=c.I.root);if(!g||b.U)for(g=0;40960===(c.mode&61440);)if(c=
Ib(d),d=sb(pb(d),c),c=W(d,{O:b.O+1}).node,40<g++)throw new T(32);}return {path:d,node:c}},Jb=a=>{for(var b;;){if(a===a.parent)return a=a.u.Z,b?"/"!==a[a.length-1]?a+"/"+b:a+b:a;b=b?a.name+"/"+b:a.name;a=a.parent;}},Kb=(a,b)=>{for(var c=0,d=0;d<b.length;d++)c=(c<<5)-c+b.charCodeAt(d)|0;return (a+c>>>0)%V.length},Cb=(a,b)=>{var c;if(c=(c=Lb(a,"x"))?c:a.h.lookup?0:2)throw new T(c,a);for(c=V[Kb(a.id,b)];c;c=c.fa){var d=c.name;if(c.parent.id===a.id&&d===b)return c}return a.h.lookup(a,b)},Ab=(a,b,c,d)=>{a=
...
{},Object.defineProperties(X.prototype,{object:{get:function(){return this.node},set:function(c){this.node=c;}},flags:{get:function(){return this.G.flags},set:function(c){this.G.flags=c;}},position:{get:function(){return this.G.position},set:function(c){this.G.position=c;}}}));a=Object.assign(new X,a);var b=Qb();a.fd=b;return Fb[b]=a},zb={open:a=>{a.l=Eb[a.node.rdev].l;a.l.open&&a.l.open(a);},D:()=>{throw new T(70);}},vb=(a,b)=>{Eb[a]={l:b};},Sb=(a,b)=>{var c="/"===b,d=!b;if(c&&Db)throw new T(10);if(!c&&
!d){var f=W(b,{V:!1});b=f.path;f=f.node;if(f.I)throw new T(10);if(16384!==(f.mode&61440))throw new T(54);}b={type:a,ma:{},Z:b,ea:[]};a=a.u(b);a.u=b;b.root=a;c?Db=a:f&&(f.I=b,f.u&&f.u.ea.push(b));},Y=(a,b,c)=>{var d=W(a,{parent:!0}).node;a=qb(a);if(!a||"."===a||".."===a)throw new T(28);var f=Pb(d,a);if(f)throw new T(f);if(!d.h.H)throw new T(63);return d.h.H(d,a,b,c)},Tb=(a,b,c)=>{"undefined"==typeof c&&(c=b,b=438);Y(a,b|8192,c);},Ub=(a,b)=>{if(!sb(a))throw new T(44);var c=W(b,{parent:!0}).node;if(!c)throw new T(44);
b=qb(b);var d=Pb(c,b);if(d)throw new T(d);if(!c.h.symlink)throw new T(63);c.h.symlink(c,b,a);},Ib=a=>{a=W(a).node;if(!a)throw new T(44);if(!a.h.readlink)throw new T(28);return sb(Jb(a.parent),a.h.readlink(a))},Wb=(a,b)=>{if(""===a)throw new T(44);if("string"==typeof b){var c=Nb[b];if("undefined"==typeof c)throw Error("Unknown file open mode: "+b);b=c;}var d=b&64?("undefined"==typeof d?438:d)&4095|32768:0;if("object"==typeof a)var f=a;else {a=ob(a);try{f=W(a,{U:!(b&131072)}).node;}catch(g){}}c=!1;if(b&
64)if(f){if(b&128)throw new T(20);}else f=Y(a,d,0),c=!0;if(!f)throw new T(44);8192===(f.mode&61440)&&(b&=-513);if(b&65536&&16384!==(f.mode&61440))throw new T(54);if(!c&&(d=f?40960===(f.mode&61440)?32:16384===(f.mode&61440)&&("r"!==Ob(b)||b&512)?31:Lb(f,Ob(b)):44))throw new T(d);if(b&512&&!c){d=f;d="string"==typeof d?W(d,{U:!0}).node:d;if(!d.h.s)throw new T(63);if(16384===(d.mode&61440))throw new T(31);if(32768!==(d.mode&61440))throw new T(28);if(c=Lb(d,"w"))throw new T(c);d.h.s(d,{size:0,timestamp:Date.now()});}b&=
-131713;f=Rb({node:f,path:Jb(f),flags:b,seekable:!0,position:0,l:f.l,pa:[],error:!1});f.l.open&&f.l.open(f);!e.logReadFiles||b&1||(Vb||(Vb={}),a in Vb||(Vb[a]=1));},Xb=()=>{T||(T=function(a,b){this.node=b;this.message="FS error";},T.prototype=Error(),T.prototype.constructor=T,[44].forEach(a=>{Bb[a]=new T(a);Bb[a].stack="<generic error, no stack>";}));},Yb,Zb=(a,b)=>{var c=0;a&&(c|=365);b&&(c|=146);return c},Z=(a,b,c)=>{a=ob("/dev/"+a);var d=Zb(!!b,!!c);$b||($b=64);var f=$b++<<8|0;vb(f,{open:g=>{g.seekable=
!1;},close:()=>{c&&c.buffer&&c.buffer.length&&c(10);},read:(g,h,m,p)=>{for(var q=0,n=0;n<p;n++){try{var r=b();}catch(E){throw new T(29);}if(void 0===r&&0===q)throw new T(6);if(null===r||void 0===r)break;q++;h[m+n]=r;}q&&(g.node.timestamp=Date.now());return q},write:(g,h,m,p)=>{for(var q=0;q<p;q++)try{c(h[m+q]);}catch(n){throw new T(29);}p&&(g.node.timestamp=Date.now());return q}});Tb(a,d,f);},$b,X,Vb;function ac(a){if(!noExitRuntime){if(e.onExit)e.onExit(a);la=!0;}k(a,new ja(a));}
function Mb(a,b,c,d){a||(a=this);this.parent=a;this.u=a.u;this.I=null;this.id=Gb++;this.name=b;this.mode=c;this.h={};this.l={};this.rdev=d;}Object.defineProperties(Mb.prototype,{read:{get:function(){return 365===(this.mode&365)},set:function(a){a?this.mode|=365:this.mode&=-366;}},write:{get:function(){return 146===(this.mode&146)},set:function(a){a?this.mode|=146:this.mode&=-147;}}});Xb();V=Array(4096);Sb(U,"/");Y("/tmp",16895,0);Y("/home",16895,0);Y("/home/web_user",16895,0);
(()=>{Y("/dev",16895,0);vb(259,{read:()=>0,write:(b,c,d,f)=>f});Tb("/dev/null",259);ub(1280,xb);ub(1536,yb);Tb("/dev/tty",1280);Tb("/dev/tty1",1536);var a=rb();Z("random",a);Z("urandom",a);Y("/dev/shm",16895,0);Y("/dev/shm/tmp",16895,0);})();(()=>{Y("/proc",16895,0);var a=Y("/proc/self",16895,0);Y("/proc/self/fd",16895,0);Sb({u:()=>{var b=Ab(a,"fd",16895,73);b.h={lookup:(c,d)=>{var f=Fb[+d];if(!f)throw new T(8);c={parent:null,u:{Z:"fake"},h:{readlink:()=>f.path}};return c.parent=c}};return b}},"/proc/self/fd");})();
var Q={__assert_fail:eb,__heap_base:Sa,__indirect_function_table:J,__memory_base:fb,__stack_pointer:gb,__table_base:hb,abort:ib,emscripten_asm_const_int:kb,emscripten_memcpy_big:lb,emscripten_resize_heap:mb,memory:C};
(function(){function a(f,g){f=f.exports;f=Ya(f,1024);e.asm=f;g=Ja(g);g.B&&(z=g.B.concat(z));La(f);ta.unshift(e.asm.__wasm_call_ctors);wa.push(e.asm.__wasm_apply_data_relocs);Ba();}function b(f){a(f.instance,f.module);}function c(f){return Fa().then(function(g){return WebAssembly.instantiate(g,d)}).then(function(g){return g}).then(f,function(g){y("failed to asynchronously prepare wasm: "+g);B(g);})}var d={env:Q,wasi_snapshot_preview1:Q,"GOT.mem":new Proxy(Q,Ia),"GOT.func":new Proxy(Q,Ia)};Aa();if(e.instantiateWasm)try{return e.instantiateWasm(d,
a)}catch(f){return y("Module.instantiateWasm callback failed with error: "+f),!1}(function(){return A||"function"!=typeof WebAssembly.instantiateStreaming||Ca()||N.startsWith("file://")||t||"function"!=typeof fetch?c(b):fetch(N,{credentials:"same-origin"}).then(function(f){return WebAssembly.instantiateStreaming(f,d).then(b,function(g){y("wasm streaming compile failed: "+g);y("falling back to ArrayBuffer instantiation");return c(b)})})})().catch(ba);return {}})();
e.___wasm_call_ctors=function(){return (e.___wasm_call_ctors=e.asm.__wasm_call_ctors).apply(null,arguments)};e.___wasm_apply_data_relocs=function(){return (e.___wasm_apply_data_relocs=e.asm.__wasm_apply_data_relocs).apply(null,arguments)};var Ua=e._malloc=function(){return (Ua=e._malloc=e.asm.malloc).apply(null,arguments)};e._sha512=function(){return (e._sha512=e.asm.sha512).apply(null,arguments)};e._random_bytes=function(){return (e._random_bytes=e.asm.random_bytes).apply(null,arguments)};
e._argon2=function(){return (e._argon2=e.asm.argon2).apply(null,arguments)};e._new_keypair=function(){return (e._new_keypair=e.asm.new_keypair).apply(null,arguments)};e._keypair_from_seed=function(){return (e._keypair_from_seed=e.asm.keypair_from_seed).apply(null,arguments)};e._keypair_from_secret_key=function(){return (e._keypair_from_secret_key=e.asm.keypair_from_secret_key).apply(null,arguments)};e._sign_data=function(){return (e._sign_data=e.asm.sign_data).apply(null,arguments)};
e._verify_data=function(){return (e._verify_data=e.asm.verify_data).apply(null,arguments)};e._calculate_nonce=function(){return (e._calculate_nonce=e.asm.calculate_nonce).apply(null,arguments)};e._encrypt_data=function(){return (e._encrypt_data=e.asm.encrypt_data).apply(null,arguments)};e._decrypt_data=function(){return (e._decrypt_data=e.asm.decrypt_data).apply(null,arguments)};
var Ra=e._setThrew=function(){return (Ra=e._setThrew=e.asm.setThrew).apply(null,arguments)},Pa=e.stackSave=function(){return (Pa=e.stackSave=e.asm.stackSave).apply(null,arguments)},Qa=e.stackRestore=function(){return (Qa=e.stackRestore=e.asm.stackRestore).apply(null,arguments)},bc=e.stackAlloc=function(){return (bc=e.stackAlloc=e.asm.stackAlloc).apply(null,arguments)};e.dynCall_iiiji=function(){return (e.dynCall_iiiji=e.asm.dynCall_iiiji).apply(null,arguments)};
...
function fc(a){var b=e._main;if(b){a=a||[];a.unshift(ea);var c=a.length,d=bc(4*(c+1)),f=d>>2;a.forEach(h=>{var m=f++,p=oa(h)+1,q=bc(p);na(h,pa,q,p);H[m]=q;});H[f]=0;try{var g=b(c,d);ac(g);}catch(h){h instanceof ja||"unwind"==h||k(1,h);}}}var gc=!1;
function ec(){function a(){if(!cc&&(cc=!0,e.calledRun=!0,!la)){K=!0;P(wa);e.noFSInit||Yb||(Yb=!0,Xb(),e.stdin=e.stdin,e.stdout=e.stdout,e.stderr=e.stderr,e.stdin?Z("stdin",e.stdin):Ub("/dev/tty","/dev/stdin"),e.stdout?Z("stdout",null,e.stdout):Ub("/dev/tty","/dev/stdout"),e.stderr?Z("stderr",null,e.stderr):Ub("/dev/tty1","/dev/stderr"),Wb("/dev/stdin",0),Wb("/dev/stdout",1),Wb("/dev/stderr",1));Hb=!1;P(ta);P(ua);aa(e);if(e.onRuntimeInitialized)e.onRuntimeInitialized();hc&&fc(b);if(e.postRun)for("function"==
typeof e.postRun&&(e.postRun=[e.postRun]);e.postRun.length;){var c=e.postRun.shift();va.unshift(c);}P(va);}}var b=b||da;if(!(0<L)){if(!gc&&(db(),gc=!0,0<L))return;if(e.preRun)for("function"==typeof e.preRun&&(e.preRun=[e.preRun]);e.preRun.length;)xa();P(sa);0<L||(e.setStatus?(e.setStatus("Running..."),setTimeout(function(){setTimeout(function(){e.setStatus("");},1);a();},1)):a());}}if(e.preInit)for("function"==typeof e.preInit&&(e.preInit=[e.preInit]);0<e.preInit.length;)e.preInit.pop()();var hc=!0;
e.noInitialRun&&(hc=!1);ec();
...
const splitSecretMemory = (secretLen, sharesLen, threshold) => {
    const memoryLen = (sharesLen * (secretLen + 1) + secretLen + threshold + LOG_AND_EXP) *
        Uint8Array.BYTES_PER_ELEMENT;
    const pages = memoryLenToPages(memoryLen);
    return new WebAssembly.Memory({ initial: pages, maximum: pages });
};
const restoreSecretMemory = (secretLen, sharesLen) => {
    const memoryLen = (sharesLen * (secretLen + 1) + secretLen + 2 * sharesLen + LOG_AND_EXP) *
        Uint8Array.BYTES_PER_ELEMENT;
    const pages = memoryLenToPages(memoryLen);
    return new WebAssembly.Memory({ initial: pages, maximum: pages });
};
...
function oa(a){for(var b=0,c=0;c<a.length;++c){var d=a.charCodeAt(c);127>=d?b++:2047>=d?b+=2:55296<=d&&57343>=d?(b+=4,++c):b+=3;}return b}var F,pa,qa,G,ra,sa=g.INITIAL_MEMORY||16777216;g.wasmMemory?D=g.wasmMemory:D=new WebAssembly.Memory({initial:sa/65536,maximum:sa/65536});D&&(F=D.buffer);sa=F.byteLength;var H=F;F=H;g.HEAP8=pa=new Int8Array(H);g.HEAP16=new Int16Array(H);g.HEAP32=G=new Int32Array(H);g.HEAPU8=qa=new Uint8Array(H);g.HEAPU16=new Uint16Array(H);g.HEAPU32=new Uint32Array(H);g.HEAPF32=new Float32Array(H);
g.HEAPF64=ra=new Float64Array(H);var I=new WebAssembly.Table({initial:5,element:"anyfunc"}),ta=[],ua=[],va=[],wa=[],ya=[],J=!1;function za(){var a=g.preRun.shift();ta.unshift(a);}var K=0,L=null;function Ba(){K++;g.monitorRunDependencies&&g.monitorRunDependencies(K);}function Ca(){K--;g.monitorRunDependencies&&g.monitorRunDependencies(K);if(0==K&&(L)){var a=L;L=null;a();}}
function B(a){if(g.onAbort)g.onAbort(a);a="Aborted("+a+")";y(a);la=!0;a=new WebAssembly.RuntimeError(a+". Build with -sASSERTIONS for more info.");ba(a);throw a;}function Da(){return M.startsWith("data:application/octet-stream;base64,")}var M;M="shamirMethodsModule.wasm";if(!Da()){var Ea=M;M=g.locateFile?g.locateFile(Ea,u):u+Ea;}function Fa(){var a=M;try{if(a==M&&A)return new Uint8Array(A);if(w)return w(a);throw "both async and sync fetching of the wasm failed";}catch(b){B(b);}}
...
function Oa(a){return function(){var b=Pa();try{var c=arguments[0],d=Array.prototype.slice.call(arguments,1);if(a.includes("j")){var e=g["dynCall_"+a];var f=d&&d.length?e.apply(null,[c].concat(d)):e.call(null,c);}else f=Na(c).apply(null,d);return f}catch(h){Qa(b);if(h!==h+0)throw h;Ra(1,0);}}}var Sa=10488864;function Ta(a){if(J)return Ua(a);var b=Sa;Sa=a=b+a+15&-16;N.__heap_base.value=a;return b}function Va(a,b){if(S)for(var c=a;c<a+b;c++){var d=Na(c);d&&S.set(d,c);}}var S=void 0,Wa=[];
...
var eb=new WebAssembly.Global({value:"i32",mutable:!1},1024),fb=new WebAssembly.Global({value:"i32",mutable:!0},10488864),gb=new WebAssembly.Global({value:"i32",mutable:!1},1),hb=[];function ib(a,b,c){a-=1024;hb.length=0;var d;for(c>>=2;d=qa[b++];)c+=105!=d&c,hb.push(105==d?G[c]:ra[c++>>1]),++c;return Ha[a].apply(null,hb)}ib.$="ippp";function jb(){B("OOM");}jb.$="ip";
...
Fb(d),d=pb(mb(d),c),c=W(d,{N:b.N+1}).node,40<f++)throw new T(32);}return {path:d,node:c}},Gb=a=>{for(var b;;){if(a===a.parent)return a=a.u.Y,b?"/"!==a[a.length-1]?a+"/"+b:a+b:a;b=b?a.name+"/"+b:a.name;a=a.parent;}},Hb=(a,b)=>{for(var c=0,d=0;d<b.length;d++)c=(c<<5)-c+b.charCodeAt(d)|0;return (a+c>>>0)%V.length},zb=(a,b)=>{var c;if(c=(c=Ib(a,"x"))?c:a.h.lookup?0:2)throw new T(c,a);for(c=V[Hb(a.id,b)];c;c=c.fa){var d=c.name;if(c.parent.id===a.id&&d===b)return c}return a.h.lookup(a,b)},xb=(a,b,c,d)=>{a=
...
{},Object.defineProperties(X.prototype,{object:{get:function(){return this.node},set:function(c){this.node=c;}},flags:{get:function(){return this.F.flags},set:function(c){this.F.flags=c;}},position:{get:function(){return this.F.position},set:function(c){this.F.position=c;}}}));a=Object.assign(new X,a);var b=Nb();a.fd=b;return Cb[b]=a},wb={open:a=>{a.l=Bb[a.node.rdev].l;a.l.open&&a.l.open(a);},D:()=>{throw new T(70);}},sb=(a,b)=>{Bb[a]={l:b};},Pb=(a,b)=>{var c="/"===b,d=!b;if(c&&Ab)throw new T(10);if(!c&&
!d){var e=W(b,{U:!1});b=e.path;e=e.node;if(e.H)throw new T(10);if(16384!==(e.mode&61440))throw new T(54);}b={type:a,ma:{},Y:b,ea:[]};a=a.u(b);a.u=b;b.root=a;c?Ab=a:e&&(e.H=b,e.u&&e.u.ea.push(b));},Y=(a,b,c)=>{var d=W(a,{parent:!0}).node;a=nb(a);if(!a||"."===a||".."===a)throw new T(28);var e=Mb(d,a);if(e)throw new T(e);if(!d.h.G)throw new T(63);return d.h.G(d,a,b,c)},Qb=(a,b,c)=>{"undefined"==typeof c&&(c=b,b=438);Y(a,b|8192,c);},Rb=(a,b)=>{if(!pb(a))throw new T(44);var c=W(b,{parent:!0}).node;if(!c)throw new T(44);
b=nb(b);var d=Mb(c,b);if(d)throw new T(d);if(!c.h.symlink)throw new T(63);c.h.symlink(c,b,a);},Fb=a=>{a=W(a).node;if(!a)throw new T(44);if(!a.h.readlink)throw new T(28);return pb(Gb(a.parent),a.h.readlink(a))},Tb=(a,b)=>{if(""===a)throw new T(44);if("string"==typeof b){var c=Kb[b];if("undefined"==typeof c)throw Error("Unknown file open mode: "+b);b=c;}var d=b&64?("undefined"==typeof d?438:d)&4095|32768:0;if("object"==typeof a)var e=a;else {a=lb(a);try{e=W(a,{T:!(b&131072)}).node;}catch(f){}}c=!1;if(b&
64)if(e){if(b&128)throw new T(20);}else e=Y(a,d,0),c=!0;if(!e)throw new T(44);8192===(e.mode&61440)&&(b&=-513);if(b&65536&&16384!==(e.mode&61440))throw new T(54);if(!c&&(d=e?40960===(e.mode&61440)?32:16384===(e.mode&61440)&&("r"!==Lb(b)||b&512)?31:Ib(e,Lb(b)):44))throw new T(d);if(b&512&&!c){d=e;d="string"==typeof d?W(d,{T:!0}).node:d;if(!d.h.s)throw new T(63);if(16384===(d.mode&61440))throw new T(31);if(32768!==(d.mode&61440))throw new T(28);if(c=Ib(d,"w"))throw new T(c);d.h.s(d,{size:0,timestamp:Date.now()});}b&=
-131713;e=Ob({node:e,path:Gb(e),flags:b,seekable:!0,position:0,l:e.l,pa:[],error:!1});e.l.open&&e.l.open(e);!g.logReadFiles||b&1||(Sb||(Sb={}),a in Sb||(Sb[a]=1));},Ub=()=>{T||(T=function(a,b){this.node=b;this.message="FS error";},T.prototype=Error(),T.prototype.constructor=T,[44].forEach(a=>{yb[a]=new T(a);yb[a].stack="<generic error, no stack>";}));},Vb,Wb=(a,b)=>{var c=0;a&&(c|=365);b&&(c|=146);return c},Z=(a,b,c)=>{a=lb("/dev/"+a);var d=Wb(!!b,!!c);Xb||(Xb=64);var e=Xb++<<8|0;sb(e,{open:f=>{f.seekable=
!1;},close:()=>{c&&c.buffer&&c.buffer.length&&c(10);},read:(f,h,m,p)=>{for(var q=0,n=0;n<p;n++){try{var r=b();}catch(C){throw new T(29);}if(void 0===r&&0===q)throw new T(6);if(null===r||void 0===r)break;q++;h[m+n]=r;}q&&(f.node.timestamp=Date.now());return q},write:(f,h,m,p)=>{for(var q=0;q<p;q++)try{c(h[m+q]);}catch(n){throw new T(29);}p&&(f.node.timestamp=Date.now());return q}});Qb(a,d,e);},Xb,X,Sb;function Yb(a){if(!noExitRuntime){if(g.onExit)g.onExit(a);la=!0;}k(a,new ja(a));}
function Jb(a,b,c,d){a||(a=this);this.parent=a;this.u=a.u;this.H=null;this.id=Db++;this.name=b;this.mode=c;this.h={};this.l={};this.rdev=d;}Object.defineProperties(Jb.prototype,{read:{get:function(){return 365===(this.mode&365)},set:function(a){a?this.mode|=365:this.mode&=-366;}},write:{get:function(){return 146===(this.mode&146)},set:function(a){a?this.mode|=146:this.mode&=-147;}}});Ub();V=Array(4096);Pb(U,"/");Y("/tmp",16895,0);Y("/home",16895,0);Y("/home/web_user",16895,0);
(()=>{Y("/dev",16895,0);sb(259,{read:()=>0,write:(b,c,d,e)=>e});Qb("/dev/null",259);rb(1280,ub);rb(1536,vb);Qb("/dev/tty",1280);Qb("/dev/tty1",1536);var a=ob();Z("random",a);Z("urandom",a);Y("/dev/shm",16895,0);Y("/dev/shm/tmp",16895,0);})();(()=>{Y("/proc",16895,0);var a=Y("/proc/self",16895,0);Y("/proc/self/fd",16895,0);Pb({u:()=>{var b=xb(a,"fd",16895,73);b.h={lookup:(c,d)=>{var e=Cb[+d];if(!e)throw new T(8);c={parent:null,u:{Y:"fake"},h:{readlink:()=>e.path}};return c.parent=c}};return b}},"/proc/self/fd");})();
var Q={__heap_base:Sa,__indirect_function_table:I,__memory_base:eb,__stack_pointer:fb,__table_base:gb,emscripten_asm_const_int:ib,emscripten_resize_heap:jb,memory:D};
...
L=function ac(){$b||bc();$b||(L=ac);};function cc(a){var b=g._main;if(b){a=a||[];a.unshift(ea);var c=a.length,d=Zb(4*(c+1)),e=d>>2;a.forEach(h=>{var m=e++,p=oa(h)+1,q=Zb(p);na(h,pa,q,p);G[m]=q;});G[e]=0;try{var f=b(c,d);Yb(f);}catch(h){h instanceof ja||"unwind"==h||k(1,h);}}}var dc=!1;
...
typeof g.postRun&&(g.postRun=[g.postRun]);g.postRun.length;){var c=g.postRun.shift();wa.unshift(c);}P(wa);}}var b=b||da;if(!(0<K)){if(!dc&&(db(),dc=!0,0<K))return;if(g.preRun)for("function"==typeof g.preRun&&(g.preRun=[g.preRun]);g.preRun.length;)za();P(ta);0<K||(g.setStatus?(g.setStatus("Running..."),setTimeout(function(){setTimeout(function(){g.setStatus("");},1);a();},1)):a());}}if(g.preInit)for("function"==typeof g.preInit&&(g.preInit=[g.preInit]);0<g.preInit.length;)g.preInit.pop()();var ec=!0;
...
function oa(a){for(var b=0,c=0;c<a.length;++c){var d=a.charCodeAt(c);127>=d?b++:2047>=d?b+=2:55296<=d&&57343>=d?(b+=4,++c):b+=3;}return b}var F,pa,qa,G,ra,sa=g.INITIAL_MEMORY||16777216;g.wasmMemory?D=g.wasmMemory:D=new WebAssembly.Memory({initial:sa/65536,maximum:sa/65536});D&&(F=D.buffer);sa=F.byteLength;var H=F;F=H;g.HEAP8=pa=new Int8Array(H);g.HEAP16=new Int16Array(H);g.HEAP32=G=new Int32Array(H);g.HEAPU8=qa=new Uint8Array(H);g.HEAPU16=new Uint16Array(H);g.HEAPU32=new Uint32Array(H);g.HEAPF32=new Float32Array(H);
g.HEAPF64=ra=new Float64Array(H);var I=new WebAssembly.Table({initial:5,element:"anyfunc"}),ta=[],ua=[],va=[],wa=[],ya=[],J=!1;function za(){var a=g.preRun.shift();ta.unshift(a);}var K=0,L=null;function Ba(){K++;g.monitorRunDependencies&&g.monitorRunDependencies(K);}function Ca(){K--;g.monitorRunDependencies&&g.monitorRunDependencies(K);if(0==K&&(L)){var a=L;L=null;a();}}
function B(a){if(g.onAbort)g.onAbort(a);a="Aborted("+a+")";y(a);la=!0;a=new WebAssembly.RuntimeError(a+". Build with -sASSERTIONS for more info.");ba(a);throw a;}function Da(){return M.startsWith("data:application/octet-stream;base64,")}var M;M="utilsMethodsModule.wasm";if(!Da()){var Ea=M;M=g.locateFile?g.locateFile(Ea,u):u+Ea;}function Fa(){var a=M;try{if(a==M&&A)return new Uint8Array(A);if(w)return w(a);throw "both async and sync fetching of the wasm failed";}catch(b){B(b);}}
function Ga(){if(!A&&(fa||l)){if("function"==typeof fetch&&!M.startsWith("file://"))return fetch(M,{credentials:"same-origin"}).then(function(a){if(!a.ok)throw "failed to load wasm binary file at '"+M+"'";return a.arrayBuffer()}).catch(function(){return Fa()});if(v)return new Promise(function(a,b){v(M,function(c){a(new Uint8Array(c));},b);})}return Promise.resolve().then(function(){return Fa()})}
...
d(!f,"need to see wasm magic number"),d(0!==a[8],"need the dylink section to be first"),e=9,f=b(),f=e+f,h=c());var m={B:[],ia:new Set,aa:new Set};if("dylink"==h){m.K=b();m.W=b();m.I=b();m.ha=b();h=b();for(var p=0;p<h;++p){var q=c();m.B.push(q);}}else for(d("dylink.0"!==h);e<f;)if(h=a[e++],p=b(),1===h)m.K=b(),m.W=b(),m.I=b(),m.ha=b();else if(2===h)for(h=b(),p=0;p<h;++p)q=c(),m.B.push(q);else if(3===h)for(h=b();h--;)p=c(),q=b(),q&256&&m.ia.add(p);else if(4===h)for(h=b();h--;)c(),p=c(),q=b(),1==(q&3)&&
m.aa.add(p);else e+=p;return m}function Ka(a){var b=["stackAlloc","stackSave","stackRestore"];return 0==a.indexOf("dynCall_")||b.includes(a)?a:"_"+a}function La(a){for(var b in a)if(a.hasOwnProperty(b)){Q.hasOwnProperty(b)||(Q[b]=a[b]);var c=Ka(b);g.hasOwnProperty(c)||(g[c]=a[b]);"__main_argc_argv"==b&&(g._main=a[b]);}}var Ma={},R=[];function Na(a){var b=R[a];b||(a>=R.length&&(R.length=a+1),R[a]=b=I.get(a));return b}
function Oa(a){return function(){var b=Pa();try{var c=arguments[0],d=Array.prototype.slice.call(arguments,1);if(a.includes("j")){var e=g["dynCall_"+a];var f=d&&d.length?e.apply(null,[c].concat(d)):e.call(null,c);}else f=Na(c).apply(null,d);return f}catch(h){Qa(b);if(h!==h+0)throw h;Ra(1,0);}}}var Sa=10492448;function Ta(a){if(J)return Ua(a);var b=Sa;Sa=a=b+a+15&-16;N.__heap_base.value=a;return b}function Va(a,b){if(S)for(var c=a;c<a+b;c++){var d=Na(c);d&&S.set(d,c);}}var S=void 0,Wa=[];
function Xa(a,b){S||(S=new WeakMap,Va(0,I.length));if(S.has(a))return S.get(a);if(Wa.length)var c=Wa.pop();else {try{I.grow(1);}catch(m){if(!(m instanceof RangeError))throw m;throw "Unable to grow wasm table. Set ALLOW_TABLE_GROWTH.";}c=I.length-1;}try{var d=c;I.set(d,a);R[d]=I.get(d);}catch(m){if(!(m instanceof TypeError))throw m;if("function"==typeof WebAssembly.Function){d=WebAssembly.Function;for(var e={i:"i32",j:"i64",f:"f32",d:"f64",p:"i32"},f={parameters:[],results:"v"==b[0]?[]:[e[b[0]]]},h=1;h<
b.length;++h)f.parameters.push(e[b[h]]);d=new d(f,a);}else {d=[1,96];e=b.slice(0,1);b=b.slice(1);f={i:127,p:127,j:126,f:125,d:124};h=b.length;128>h?d.push(h):d.push(h%128|128,h>>7);for(h=0;h<b.length;++h)d.push(f[b[h]]);"v"==e?d.push(0):d.push(1,f[e]);b=[0,97,115,109,1,0,0,0,1];e=d.length;128>e?b.push(e):b.push(e%128|128,e>>7);b.push.apply(b,d);b.push(2,7,1,1,101,1,102,0,0,7,5,1,1,102,0,0);d=new WebAssembly.Module(new Uint8Array(b));d=(new WebAssembly.Instance(d,{e:{f:a}})).exports.f;}b=c;I.set(b,d);
R[b]=I.get(b);}S.set(a,c);return c}
function Ya(a,b){var c={},d;for(d in a){var e=a[d];"object"==typeof e&&(e=e.value);"number"==typeof e&&(e+=b);c[d]=e;}a=void 0;for(var f in c)!"__cpp_exception __c_longjmp __wasm_apply_data_relocs __dso_handle __tls_size __tls_align __set_stack_limits _emscripten_tls_init __wasm_init_tls __wasm_call_ctors".split(" ").includes(f)&&(b=c[f],f.startsWith("orig$")&&(f=f.split("$")[1],a=!0),N[f]||(N[f]=new WebAssembly.Global({value:"i32",mutable:!0})),a||0==N[f].value)&&("function"==typeof b?N[f].value=
...
b)}):ab(c(a),b)}function e(h){f.global&&La(h);f.module=h;}b=b||{global:!0,L:!0};var f=Ma[a];if(f)return b.global&&!f.global&&(f.global=!0,"loading"!==f.module&&La(f.module)),b.L&&Infinity!==f.O&&(f.O=Infinity),f.O++,b.A?Promise.resolve(!0):!0;f={O:b.L?Infinity:1,name:a,module:"loading",global:b.global};Ma[a]=f;if(b.A)return d().then(function(h){e(h);return !0});e(d());return !0}
function bb(){for(var a in N)if(0==N[a].value){var b=Za(a,!0);if(b||N[a].required)if("function"==typeof b)N[a].value=Xa(b,b.$);else if("number"==typeof b)N[a].value=b;else throw Error("bad export type for `"+a+"`: "+typeof b);}}function db(){z.length?(Ba(),z.reduce(function(a,b){return a.then(function(){return cb(b,{A:!0,global:!0,L:!0,ba:!0})})},Promise.resolve()).then(function(){bb();Ca();})):bb();}
var eb=new WebAssembly.Global({value:"i32",mutable:!1},1024),fb=new WebAssembly.Global({value:"i32",mutable:!0},10492448),gb=new WebAssembly.Global({value:"i32",mutable:!1},1),hb=[];function ib(a,b,c){a-=1024;hb.length=0;var d;for(c>>=2;d=qa[b++];)c+=105!=d&c,hb.push(105==d?G[c]:ra[c++>>1]),++c;return Ha[a].apply(null,hb)}ib.$="ippp";function jb(){B("OOM");}jb.$="ip";
var kb=(a,b)=>{for(var c=0,d=a.length-1;0<=d;d--){var e=a[d];"."===e?a.splice(d,1):".."===e?(a.splice(d,1),c++):c&&(a.splice(d,1),c--);}if(b)for(;c;c--)a.unshift("..");return a},lb=a=>{var b="/"===a.charAt(0),c="/"===a.substr(-1);(a=kb(a.split("/").filter(d=>!!d),!b).join("/"))||b||(a=".");a&&c&&(a+="/");return (b?"/":"")+a},mb=a=>{var b=/^(\/?|)([\s\S]*?)((?:\.{1,2}|[^\/]+?|)(\.[^.\/]*|))(?:[\/]*)$/.exec(a).slice(1);a=b[0];b=b[1];if(!a&&!b)return ".";b&&(b=b.substr(0,b.length-1));return a+b},nb=a=>
{if("/"===a)return "/";a=lb(a);a=a.replace(/\/$/,"");var b=a.lastIndexOf("/");return -1===b?a:a.substr(b+1)};function ob(){if("object"==typeof crypto&&"function"==typeof crypto.getRandomValues){var a=new Uint8Array(1);return ()=>{crypto.getRandomValues(a);return a[0]}}if(t)try{var b=require("crypto");return ()=>b.randomBytes(1)[0]}catch(c){}return ()=>B("randomDevice")}
function pb(){for(var a="",b=!1,c=arguments.length-1;-1<=c&&!b;c--){b=0<=c?arguments[c]:"/";if("string"!=typeof b)throw new TypeError("Arguments to path.resolve must be strings");if(!b)return "";a=b+"/"+a;b="/"===b.charAt(0);}a=kb(a.split("/").filter(d=>!!d),!b).join("/");return (b?"/":"")+a||"."}var qb=[];function rb(a,b){qb[a]={input:[],output:[],C:b};sb(a,tb);}
var tb={open:function(a){var b=qb[a.node.rdev];if(!b)throw new T(43);a.tty=b;a.seekable=!1;},close:function(a){a.tty.C.flush(a.tty);},flush:function(a){a.tty.C.flush(a.tty);},read:function(a,b,c,d){if(!a.tty||!a.tty.C.V)throw new T(60);for(var e=0,f=0;f<d;f++){try{var h=a.tty.C.V(a.tty);}catch(m){throw new T(29);}if(void 0===h&&0===e)throw new T(6);if(null===h||void 0===h)break;e++;b[c+f]=h;}e&&(a.node.timestamp=Date.now());return e},write:function(a,b,c,d){if(!a.tty||!a.tty.C.M)throw new T(60);try{for(var e=
...
function cc(a){var b=g._main;if(b){a=a||[];a.unshift(ea);var c=a.length,d=Zb(4*(c+1)),e=d>>2;a.forEach(h=>{var m=e++,p=oa(h)+1,q=Zb(p);na(h,pa,q,p);G[m]=q;});G[e]=0;try{var f=b(c,d);Yb(f);}catch(h){h instanceof ja||"unwind"==h||k(1,h);}}}var dc=!1;
function bc(){function a(){if(!$b&&($b=!0,g.calledRun=!0,!la)){J=!0;P(ya);g.noFSInit||Vb||(Vb=!0,Ub(),g.stdin=g.stdin,g.stdout=g.stdout,g.stderr=g.stderr,g.stdin?Z("stdin",g.stdin):Rb("/dev/tty","/dev/stdin"),g.stdout?Z("stdout",null,g.stdout):Rb("/dev/tty","/dev/stdout"),g.stderr?Z("stderr",null,g.stderr):Rb("/dev/tty1","/dev/stderr"),Tb("/dev/stdin",0),Tb("/dev/stdout",1),Tb("/dev/stderr",1));Eb=!1;P(ua);P(va);aa(g);if(g.onRuntimeInitialized)g.onRuntimeInitialized();ec&&cc(b);if(g.postRun)for("function"==
typeof g.postRun&&(g.postRun=[g.postRun]);g.postRun.length;){var c=g.postRun.shift();wa.unshift(c);}P(wa);}}var b=b||da;if(!(0<K)){if(!dc&&(db(),dc=!0,0<K))return;if(g.preRun)for("function"==typeof g.preRun&&(g.preRun=[g.preRun]);g.preRun.length;)za();P(ta);0<K||(g.setStatus?(g.setStatus("Running..."),setTimeout(function(){setTimeout(function(){g.setStatus("");},1);a();},1)):a());}}if(g.preInit)for("function"==typeof g.preInit&&(g.preInit=[g.preInit]);0<g.preInit.length;)g.preInit.pop()();var ec=!0;
g.noInitialRun&&(ec=!1);bc();
