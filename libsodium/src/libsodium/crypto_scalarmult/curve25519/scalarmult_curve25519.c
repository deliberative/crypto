...
static const crypto_scalarmult_curve25519_implementation *scalarmult_curve25519_implementation =
                             ...
                             const unsigned char *p)
{
    ...
    if (scalarmult_curve25519_implementation->mult(q, n, p) != 0) {
...
{
    scalarmult_curve25519_implementation = &crypto_scalarmult_curve25519_ref10_implementation;

#ifdef HAVE_AVX_ASM
    if (sodium_runtime_has_avx()) {
        scalarmult_curve25519_implementation = &crypto_scalarmult_curve25519_sandy2x_implementation;
    }
#endif
    return 0;
}
