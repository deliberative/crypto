...
static const crypto_stream_chacha20_implementation *stream_chacha20_implementation =
                       ...
                       const unsigned char *n, const unsigned char *k)
{
    ...
    return stream_chacha20_implementation->stream(c, clen, n, k);
}
                              ...
                              const unsigned char *k)
{
    ...
    return stream_chacha20_implementation->stream_xor_ic(c, m, mlen, n, ic, k);
}
                           ...
                           const unsigned char *k)
{
    ...
    return stream_chacha20_implementation->stream_xor_ic(c, m, mlen, n, 0U, k);
}
                                ...
                                const unsigned char *n, const unsigned char *k)
{
    ...
    return stream_chacha20_implementation->stream_ietf_ext(c, clen, n, k);
}
                                       ...
                                       const unsigned char *k)
{
    ...
    return stream_chacha20_implementation->stream_ietf_ext_xor_ic(c, m, mlen, n, ic, k);
}
                                    ...
                                    const unsigned char *k)
{
    ...
    return stream_chacha20_implementation->stream_ietf_ext_xor_ic(c, m, mlen, n, 0U, k);
}
...
{
    stream_chacha20_implementation = &crypto_stream_chacha20_ref_implementation;
#if defined(HAVE_AVX2INTRIN_H) && defined(HAVE_EMMINTRIN_H) && \
    defined(HAVE_TMMINTRIN_H) && defined(HAVE_SMMINTRIN_H)
    if (sodium_runtime_has_avx2()) {
        stream_chacha20_implementation = &crypto_stream_chacha20_dolbeau_avx2_implementation;
        return 0;
    }
#endif
#if defined(HAVE_EMMINTRIN_H) && defined(HAVE_TMMINTRIN_H)
    if (sodium_runtime_has_ssse3()) {
        stream_chacha20_implementation = &crypto_stream_chacha20_dolbeau_ssse3_implementation;
        return 0;
    }
#endif
    return 0;
